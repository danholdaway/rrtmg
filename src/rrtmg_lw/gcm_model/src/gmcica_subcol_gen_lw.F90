!     path:      $Source: /cvsroot/esma/esma/src/Components/GEOSirrad_GridComp/RRTMG/rrtmg_lw/gcm_model/src/gmcica_subcol_gen_lw.F90,v $
!     author:    $Author: mathomp4 $
!     revision:  $Revision: 1.1.1.2.56.2 $
!     created:   $Date: 2018/09/12 13:23:37 $
!
#include "_gpudef.inc"
