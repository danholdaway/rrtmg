!     path:      $Source: /cvsroot/esma/esma/src/Components/GEOSirrad_GridComp/RRTMG/rrtmg_lw/gcm_model/src/gpu_rrtmg_lw_taumol.F90,v $
!     author:    $Author: mathomp4 $
!     revision:  $Revision: 1.1.1.1.56.1 $
!     created:   $Date: 2018/01/11 14:16:03 $
!
#include "_gpudef.inc"
#include "_memdef.inc"
